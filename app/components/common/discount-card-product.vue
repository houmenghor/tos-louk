<template>
  ...
  >
    <!-- Discount Badge -->
    <div v-if="product.badge && product.badge !== 'Best Seller'" class="deal-badge position-absolute z-2">
    ...
    >
      ...
      <div class="img-overlay" :class="{ 'overlay-visible': hovered }">
        <button class="overlay-cart-btn" @click.prevent="handleAddToCart">
          Quick Add
        </button>
      </div>
    </NuxtLink>
    ...
    <div class="card-content">
      ...
      <div class="title-desc-group">
        ...
        <p class="product-desc">{{ product.description || product.desc || 'Discover our latest premium collection featuring high-quality materials and modern design.' }}</p>
      </div>
