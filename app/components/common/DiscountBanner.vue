        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <p class="text-white-50 small">
                    Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Don't
                    miss these limited-time savings.
                </p>
            </div>
            <div class="col-lg-6">
                <div class="d-flex align-items-center justify-content-lg-end gap-3">
                    <div class="text-center text-white">
                        ...
                        <div class="d-flex gap-2 mt-1">
                            <div class="time-box">{{ formatNumber(days) }}<small class="d-block">DAYS</small></div>
                            <div class="time-box">{{ formatNumber(hours) }}<small class="d-block">HOURS</small></div>
                            <div class="time-box">{{ formatNumber(minutes) }}<small class="d-block">MINUTES</small></div>
                            <div class="time-box">{{ formatNumber(seconds) }}<small class="d-block">SECONDS</small></div>
                        </div>
                    </div>
