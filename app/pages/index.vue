    ...
    <div class="theme-wrapper">
                ...
                <div class="row align-items-center gy-5">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="d-flex flex-wrap gap-4 small subtitle-text mt-3">
                            ...
                            <span class="d-flex align-items-center gap-2">
                                <i class="bi bi-shield-check text-primary-icon"></i> Verified Quality
                            </span>
                            <span class="d-flex align-items-center gap-2">
                                <i class="bi bi-arrow-return-left text-primary-icon"></i> Easy Returns
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7">
                        <div class="row g-3">
                            <div class="col-md-5">
                                <div class="card glass-card h-100 border-0 shadow-sm p-3 position-relative">
                                    ...
                                    <div class="card-body px-1 pb-0 mt-auto">
                                        <h6 class="card-title text-truncate mb-1">Precision Audio Hub</h6>
                                        <p class="price-text fw-bold mb-0">
                                            $219 <del class="subtitle-text fw-normal small ms-1">$299</del>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-7">
                                <div class="card glass-card h-100 border-0 shadow-sm p-3 position-relative">
                                    ...
                                    <div class="card-body px-1 pb-0 mt-auto">
                                        ...
                                        <p class="price-text fw-bold mb-0">
                                            $159 <del class="subtitle-text fw-normal small ms-1">$229</del>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card glass-card border-0 shadow-sm p-3 position-relative">
                                    <span class="badge custom-badge position-absolute top-0 start-0 m-3 z-1">Just
                                        Launched</span>
                                    <div class="row g-0 align-items-center mt-4">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="card-body py-0 pe-1">
                                                <h6 class="card-title mb-2">Essential Daily Companion</h6>
                                                ...
                                                <p class="price-text fw-bold mb-0">
                                                    $99 <del class="subtitle-text fw-normal small ms-1">$149</del>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="container position-relative px-0 px-md-4">
                ...
                <div class="scroll-track px-3 px-md-0" ref="carouselTrack" @mousedown="startDrag" @mouseleave="stopDrag"
                    ...
                    <div v-for="product in productsList" :key="product.id" class="product-slide">
                        <div class="card glass-card h-100 border-0 shadow-sm p-3 pointer-events-none">
                            ...
                            <div class="card-body p-0 mt-auto">
                                ...
                                <p class="price-text fw-bold mb-0">
                                    ${{ product.price }}
                                    <del v-if="product.oldPrice" class="subtitle-text fw-normal small ms-1">${{
        ...
        <section class="category-tabs py-6">
            <div class="container">
                <div class="tab-header d-flex justify-content-center align-items-center mb-5 gap-3">
                    <button v-for="tab in tabs" :key="tab.id" @click="activeTab = tab.id" class="tab-pill"
                ...
                <transition name="fade" mode="out-in">
                    <div :key="activeTab" class="row g-4 justify-content-center">
                        <div v-for="item in currentCategoryData" :key="item.id" class="col-12 col-md-4 col-lg-3">
                ...
                <div class="text-center mt-5">
                    <button class="btn btn-primary-custom rounded-pill px-5 py-2">View All Products →</button>
                </div>
            </div>
        </section>
        ...
        <section id="best-seller" class="best-seller py-6">
            <div class="container">
                ...
                <div class="row g-4">
                    <div v-for="item in bestSellersData" :key="item.id" class="col-lg-3 col-md-4">
...
const categoryData = {
    all: [
        { id: 1, title: 'Premium Headphones', price: 249.99, image: 'https://placehold.co/300x300' },
        { id: 2, title: 'Casual Cotton T-Shirt', price: 29.99, image: 'https://placehold.co/300x300' },
        { id: 3, title: 'Leather Watch Strap', price: 59.99, image: 'https://placehold.co/300x300' },
        { id: 4, title: 'Smart Fitness Band', price: 89.99, image: 'https://placehold.co/300x300' }
    ],
    men: [
        { id: 5, title: 'Slim Fit Denim', price: 79.99, image: 'https://placehold.co/300x300' },
        { id: 6, title: 'Classic Polo Shirt', price: 45.00, image: 'https://placehold.co/300x300' },
        { id: 7, title: 'Wool Blend Blazer', price: 129.99, image: 'https://placehold.co/300x300' },
        { id: 8, title: 'Casual Chinos', price: 65.00, image: 'https://placehold.co/300x300' }
    ],
    accessories: [
        { id: 9, title: 'Minimalist Wallet', price: 35.00, image: 'https://placehold.co/300x300' },
        { id: 10, title: 'Polarized Sunglasses', price: 120.00, image: 'https://placehold.co/300x300' },
        { id: 11, title: 'Leather Belt', price: 45.00, image: 'https://placehold.co/300x300' },
        { id: 12, title: 'Travel Backpack', price: 95.00, image: 'https://placehold.co/300x300' }
    ],
    electronics: [
        { id: 1, title: 'Consectetur adipiscing elit', price: 249.99, image: 'https://placehold.co/300x300' },
        { id: 2, title: 'Magna aliqua ut enim', price: 199.99, image: 'https://placehold.co/300x300' },
        { id: 3, title: 'Ex ea commodo consequat', price: 159.99, image: 'https://placehold.co/300x300' },
        { id: 13, title: 'Wireless Charging Pad', price: 49.99, image: 'https://placehold.co/300x300' }
    ]
};
...
const bestSellersData = [
    { id: 1, title: 'Donec sollicitudin molestie malesuada viverra', category: 'PREMIUM COLLECTION', price: 149.00, rating: 4.2, reviews: 24, badge: 'Limited Edition', image: 'https://placehold.co/200x200/png?text=Item+1' },
    { id: 2, title: 'Pellentesque in ipsum lacinia orci rutrum', category: 'BEST SELLER', price: 165.00, oldPrice: 220.00, rating: 4.7, reviews: 58, badge: '25% Off', image: 'https://placehold.co/200x200/png?text=Item+2' },
    { id: 3, title: 'Quisque velit nisi pretium ut lacinia', category: 'NEW ARRIVAL', price: 89.00, rating: 3.8, reviews: 12, colors: ['red', 'blue', 'green'], image: 'https://placehold.co/200x200/png?text=Item+3' },
    { id: 4, title: 'Sed porttitor lectus nibh vivamus magna', category: 'EDITOR\'S PICK', price: 199.00, rating: 4.9, reviews: 71, badge: 'Trending', colors: ['#475569', '#7c3aed', '#f97316'], image: 'https://placehold.co/200x200/png?text=Item+4' }
];
...
const discountProducts = [
    { id: 101, title: 'Premium Wireless Headphones', price: 98, oldPrice: 179, badge: '-45%', image: 'https://placehold.co/200x200' },
    { id: 102, title: 'Smart Fitness Tracker Pro', price: 60, oldPrice: 120, badge: '-50%', image: 'https://placehold.co/200x200' },
    { id: 103, title: 'Lightweight Travel Backpack', price: 136, oldPrice: 210, badge: '-35%', image: 'https://placehold.co/200x200' },
